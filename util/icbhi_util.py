...
def generate_fbank(args, audio, sample_rate, n_mels=128,frame_shift=10): 
    """
...
def generate_spectrogram(self, fbank_data):
        # Convert fbank data to an image format (spectrogram)
        # This is a placeholder, adjust according to your actual conversion method
        return Image.fromarray(np.uint8(fbank_data * 255))
